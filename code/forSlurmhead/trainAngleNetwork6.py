...
c = 30 # 10 seems good, scales weights to 0 ... 1
tauRise = 0.001
tauDecay = 0.015
learningRate = 10**-3
...
plt.xlabel("t [s]")
plt.savefig("c30_35/distinctZ.png")