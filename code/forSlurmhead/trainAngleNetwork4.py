...
if not os.path.exists("c30_2"):
  os.mkdir("c30_2")
np.save("c30_2/c30_2_YZWeights.npy", weights)
...
plt.ylabel("Z Neuron")
plt.xlabel("t [s]")
plt.savefig("c30_2/50LastZSpikes.png")
...
plt.xlabel("t [s]")
plt.savefig("c30_2/distinctZ.png")