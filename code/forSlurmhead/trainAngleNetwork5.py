...
if not os.path.exists("c30_25"):
  os.mkdir("c30_25")
np.save("c30_25/c30_25_YZWeights.npy", weights)
...
plt.ylabel("Z Neuron")
plt.xlabel("t [s]")
plt.savefig("c30_25/50LastZSpikes.png")
...
plt.xlabel("t [s]")
plt.savefig("c30_25/distinctZ.png")