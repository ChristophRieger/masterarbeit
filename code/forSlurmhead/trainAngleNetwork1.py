...
if not os.path.exists("c20_2"):
  os.mkdir("c20_2")
np.save("c20_2/c20_2_YZWeights.npy", weights)
...
plt.ylabel("Z Neuron")
plt.xlabel("t [s]")
plt.savefig("c20_2/50LastZSpikes.png")
...
plt.xlabel("t [s]")
plt.savefig("c20_2/distinctZ.png")