...
if not os.path.exists("c20_25"):
  os.mkdir("c20_25")
np.save("c20_25/c20_25_YZWeights.npy", weights)
...
plt.ylabel("Z Neuron")
plt.xlabel("t [s]")
plt.savefig("c20_25/50LastZSpikes.png")
...
plt.xlabel("t [s]")
plt.savefig("c20_25/distinctZ.png")