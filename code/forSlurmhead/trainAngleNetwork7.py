...
c = 10 # 10 seems good, scales weights to 0 ... 1
tauRise = 0.001
tauDecay = 0.015
learningRate = 10**-3
...
if not os.path.exists("c10_3"):
  os.mkdir("c10_3")
np.save("c10_3/c10_3_YZWeights.npy", weights)
...
plt.ylabel("Z Neuron")
plt.xlabel("t [s]")
plt.savefig("c10_3/50LastZSpikes.png")
...
plt.xlabel("t [s]")
plt.savefig("c10_3/distinctZ.png")