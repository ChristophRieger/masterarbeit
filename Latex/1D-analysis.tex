...
w^P = \ln(P^{Y|Z}).
\end{equation}
%TODO say that the 6 different input images were handpicked to analyse different edge cases
...
%TODO update all result plot captions
%TODO mention tables whenever you insert them.
%TODO update references to new result plots, as no more values are inside them.
