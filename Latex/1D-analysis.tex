...
%TODO AAAAAAAAA
\subparagraph{$\boldsymbol{\tau_{decay} = 0.015\text{ seconds}$, $f_{prior} = 0\text{ Hz}}$}
...
\centering
  ...
  \caption{\textbf{KL divergence for different $f_{input}$ values. } Hyperparameters: $f_{prior} = 0\text{ Hz}, \tau_{decay} = 15\text{ ms}$}
...
\subparagraph{$\tau_{decay} = 0.004\text{ seconds}$, $f_{prior} = 0\text{ Hz}$}
...
\centering
  ...
  \caption{\textbf{KL divergence for different $f_{input}$ values.} Hyperparameters: $f_{prior} = 0\text{ Hz}, \tau_{decay} = 4\text{ ms}$}
...
\subparagraph{$\tau_{decay} = 0.015\text{ seconds}$, $f_{input} = 42\text{ Hz}$}
...
\centering
  ...
  \caption{\textbf{KL divergence for different $f_{prior}$ values.} Hyperparameters: $f_{input} = 42\text{ Hz}, \tau_{decay} = 15\text{ ms}$}
...
\subparagraph{$\tau_{decay} = 0.004\text{ seconds}$, $f_{input} = 88\text{ Hz}$}
...
\centering
  ...
  \caption{\textbf{KL divergence for different $f_{prior}$ values.} Hyperparameters: $f_{input} = 88\text{ Hz}, \tau_{decay} = 4\text{ ms}$}
...
\subparagraph{$\tau_{decay} = 0.004\text{ seconds}$, $f_{input} = 98\text{ Hz}$, $f_{prior} = 440\text{ Hz}$}
...
\centering
  ...
  \caption{\textbf{KL divergence for different $f_{input}$ values.} Hyperparameters: $f_{prior} = 440\text{ Hz}, \tau_{decay} = 4\text{ ms}$}
