...
\input{biological-background}

\chapter{Theoretical background}
\input{theoretical-background}

\chapter{Experiments}
The time constant for the rise of the signal $\tau_{rise}$ was 1 ms and the time constant for the decay of the signal $\tau_{decay}$ was 15 ms.
\input{1D-analysis}
\input{horvert}
\input{rotated-bars}
