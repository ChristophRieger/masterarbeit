...
%TODO Combine 2 plots (cross image and f) of variable prior cross.
...
%TODO add ABCD to png AND swap height and width of A for horizontal/vertical position AND C change x label to vertical position. AND completely rework D.. => relative frequency of most active output neuron.
\begin{figure}
...
\begin{figure}
  \includegraphics[width=\linewidth]{figures/horvertAdaptiveInh/20priors_pos5and12/mergedCrossHorvert.png}
