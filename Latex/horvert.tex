...
For this experiment the WTA network will be shown images of either horizontal or vertical lines. Through unsupervised learning the output neurons shall learn to group the images together, depending on the orientation and position of the lines. 
The effect of the prior neurons will be demonstrated by generating ambiguous images which show a horizontal and a vertical line at the same time. Depending on the activity of the prior neurons the output neurons will respond more to the horizontal, or to the vertical line of the image. 
